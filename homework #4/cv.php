...
$works = [
  ...
  'dataStart' => 'дата начала работы 1',
  'dataEnd' => 'дата окончания работы 1',
  'description' => 'тут описание работы 1',
  ],

  ['name' => 'Название должности 2',
  'dataStart' => 'дата начала работы 2',
  'dataEnd' => 'дата окончания работы 2',
  'description' => 'тут описание работы 2',
  ],

  ['name' => 'Название должности 3',
  'dataStart' => 'дата начала работы 3',
  'dataEnd' => 'дата окончания работы 3',
  'description' => 'тут описание работы 3',
  ],
];
?>
